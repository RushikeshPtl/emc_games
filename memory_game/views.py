...
class MemoryPerformanceView(APIView):
    def post(self,request):
        ...
        if memorynum.number == str(inputnum):
            mPerformance=MemoryPerformance.objects.create(user_id=client_id,event_id=event_id,memoryroom=memoryroom,memorynumber=memorynum,inputnumber=inputnum,is_correct=True)
        else:
            mPerformance=MemoryPerformance.objects.create(user_id=client_id,event_id=event_id,memoryroom=memoryroom,memorynumber=memorynum,inputnumber=inputnum,is_correct=False)
